...
int16\+\_\+t \mbox{\hyperlink{classmpu6050_a2987420c20802beae21fc957233b49c0}{speed\+\_\+\+Test}} ()
\begin{DoxyCompactList}\small\item\em Speed Test(no parameters) \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classmpu6050_a553ceb179631eabf3eb0d5e085464a4c}{test\+\_\+function}} ()
\begin{DoxyCompactList}\small\item\em Smal test function. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
{\footnotesize\ttfamily int16\+\_\+t mpu6050\+::speed\+\_\+\+Test (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



Speed Test(no parameters) 

First we get the value of the Z axis(accel\+\_\+\+Z) so we can determen our start point. Then we make a start point for the low value and the high value\textquotesingle{}s The low value gets -\/ 1500 and the high value + 1500. So we have a cap at what point the acceleration is higher then the basic air pressure. After all this we do the Start up function to wake the chip. If that is done we start a for loop and first check if the value the given value from the chip is higher then our high\+\_\+cap or lower then our low\+\_\+cap. So we can determen wich formule we need to use. After 1 of the 2 is true we quickly save the value of the current Z axis. Extra Note\+: when we hold the chip horizontal there is already a output of a average of 1g on the chip because of gravity so it should be already around 16000. \mbox{\Hypertarget{classmpu6050_a62b5b93afa6a09478aabb733e2a52ff0}\label{classmpu6050_a62b5b93afa6a09478aabb733e2a52ff0}} 
...
Writes 0 to 0x6B to wake up the \mbox{\hyperlink{classmpu6050}{mpu6050}} in case it is in sleeping mode so we can communicate with the \mbox{\hyperlink{classmpu6050}{mpu6050}}. \mbox{\Hypertarget{classmpu6050_a553ceb179631eabf3eb0d5e085464a4c}\label{classmpu6050_a553ceb179631eabf3eb0d5e085464a4c}} 
\index{mpu6050@{mpu6050}!test\_function@{test\_function}}
\index{test\_function@{test\_function}!mpu6050@{mpu6050}}
\doxysubsubsection{\texorpdfstring{test\_function()}{test\_function()}}
{\footnotesize\ttfamily void mpu6050\+::test\+\_\+function (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
